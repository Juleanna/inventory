...
class AutomationRule(models.Model):
    ...
    trigger_type = models.CharField(max_length=50, choices=TRIGGER_CHOICES, verbose_name='Тип тригера')
    ...
    last_run = models.DateTimeField(null=True, blank=True, verbose_name='Останній запуск')
...
class AutomationEngine:
    ...
    def _get_matching_equipment(rule: AutomationRule):
        ...
        if rule.trigger_type == 'EQUIPMENT_AGE':
            ...
            return Equipment.objects.filter(
                purchase_date__lte=cutoff, status='WORKING'
            )
            ...
            return Equipment.objects.filter(
                ...
                models.Q(last_maintenance_date__isnull=True, purchase_date__lt=cutoff),
                status='WORKING'
            )
    ...
    @staticmethod
    def _execute_action(action_config: dict, equipment: Equipment, rule: AutomationRule):
        ...
        if action_type == 'CHANGE_STATUS':
            ...
            try:
                ...
                WebhookService.send_webhook('automation.triggered', {
                    'rule': rule.name,
            ...
            try:
                ...
                MaintenanceRequest.objects.create(
                    equipment=equipment,
                    requester=rule.created_by or User.objects.filter(is_staff=True).first(),
...
class AutomationRuleSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ['created_by', 'last_run', 'run_count', 'created_at', 'updated_at']
