...
urlpatterns = [
    ...
    path(
        "api/spare-parts/movements/",
        views.SparePartMovementView.as_view(),
    ...
    path(
        "api/spare-parts/receive/",
        views.ReceiveSparePartView.as_view(),
        name="receive-spare-part",
    ),
    path(
        "api/spare-parts/create-order/",
        views.CreatePurchaseOrderView.as_view(),
        name="create-purchase-order",
    ),
    path(
        "api/spare-parts/equipment/<str:equipment_id>/",
        views.get_spare_parts_for_equipment,
        name="spare-parts-for-equipment",
    ),
    path(
        "api/spare-parts/analytics/",
        views.spare_parts_analytics,
    ...
    path(
        ...
        analytics.maintenance_analytics,
    ...
    path(
        ...
        mobile_views.mobile_equipment_list,
        name="mobile_equipment_list",
    ),
    path("api/mobile/scan/", mobile_views.scan_qr_code, name="mobile_scan_qr"),
    path(
        "api/mobile/update_location/",
        mobile_views.update_equipment_location,
        name="mobile_update_location",
    ),
    path(
        "api/mobile/report_issue/",
        mobile_views.report_issue,
        name="mobile_report_issue",
    ),
    path(
        "api/mobile/my_equipment/",
        mobile_views.mobile_user_equipment,
        name="mobile_user_equipment",
    ),
    path(
    ...
    path(
        "api/mobile/notifications/<int:notification_id>/read/",
        mobile_views.mark_notification_read,
        name="mobile_mark_notification_read",
    ),
    path(
        "api/mobile/dashboard/", mobile_views.mobile_dashboard, name="mobile_dashboard"
    ),
    ...
    path(
        "api/dashboard/equipment-overview/",
    ...
    path(
        ...
        PersonalizedDashboardView.as_view(),
    ...
    path(
        "api/users/<int:user_id>/equipment/",
        views.user_equipment,
        name="user-equipment",
    ),
    ...
    path(
        "api/maintenance/assign-technician/",
    ...
    path(
        ...
        MaintenanceScheduleView.as_view(),
    ...
    path(
        "api/maintenance/create-scheduled/",
        views.create_scheduled_maintenance,
        name="create-scheduled-maintenance",
    ),
    # ============ SPARE PARTS MANAGEMENT (routes moved before router) ============
    # ============ ДОКУМЕНТИ ОБЛАДНАННЯ ============
    path(
        "api/equipment/<int:equipment_id>/documents/<int:doc_id>/",
        views.delete_equipment_document,
        name="delete-equipment-document",
    ),
    # ============ AGENT ============
    ...
    path(
        "api/backups/download/<str:filename>/",
        BackupDownloadView.as_view(),
        name="backup-download",
    ),
    path(
        "api/backups/delete/<str:filename>/",
        BackupDeleteView.as_view(),
        name="backup-delete",
    ),
    path(
        "api/backups/contents/<str:filename>/",
        BackupContentsView.as_view(),
        name="backup-contents",
    ),
    path(
        "api/backups/restore/<str:filename>/",
        BackupRestoreView.as_view(),
        name="backup-restore",
    ),
    path(
        "api/backups/upload-gdrive/",
        BackupUploadGDriveView.as_view(),
        name="backup-upload-gdrive",
    ),
    path(
        "api/backups/gdrive/status/", GDriveStatusView.as_view(), name="gdrive-status"
    ),
    path(
        "api/backups/gdrive/authorize/",
        GDriveAuthorizeView.as_view(),
        name="gdrive-authorize",
    ),
    path(
        "api/backups/gdrive/credentials/",
        GDriveUploadCredentialsView.as_view(),
        name="gdrive-credentials",
    ),
    path(
        "api/backups/gdrive/delete/<str:file_id>/",
        GDriveDeleteView.as_view(),
        name="gdrive-delete",
    ),
    # ============ ADVANCED FEATURES ============
    ...
    path(
        ...
        DepreciationReportView.as_view(),
        name="depreciation-report",
    ),
    path(
        "api/equipment/compare/",
        EquipmentCompareView.as_view(),
    ...
    path(
        ...
        AdvancedDashboardWidgetsView.as_view(),
        name="dashboard-widgets",
    ),
    path("api/export/report/", ExportReportView.as_view(), name="export-report"),
    path(
        "api/equipment/bulk-operations/",
        BulkOperationsView.as_view(),
